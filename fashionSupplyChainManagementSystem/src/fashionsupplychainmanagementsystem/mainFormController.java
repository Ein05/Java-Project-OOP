...
public class mainFormController implements Initializable {
    ...
    @FXML
    private ComboBox<String> inventory_size;
            ...
            try {
                ...
                if (result.next()) {
                    ...
                    String insertData = "INSERT INTO product "
                            + "(prod_id, prod_name, type, stock, price, status, image, date, size, color) "
                            + "VALUES(?,?,?,?,?,?,?,?,?,?)";
                    ...
                    prepare.setString(9, (String) inventory_size.getSelectionModel().getSelectedItem());
                    prepare.setString(10, inventory_color.getText());
    ...
    public void inventoryUpdateBtn() {
        ...
        if (inventory_productID.getText().isEmpty()
                ...
                || inventory_size.getSelectionModel().getSelectedItem() == null
                || inventory_color.getText().isEmpty()
                || data.path == null || data.path.isEmpty() || data.id == null || data.id == 0) {
            ...
            String updateData = "UPDATE product SET "
                    ...
                    + path + "', date = '"
                    + data.date + "', size = '"
                    + inventory_size.getSelectionModel().getSelectedItem() + "', color = '"
                    + inventory_color.getText() + "' WHERE id = " + data.id;
    ...
    public void inventorySelectData() {
        ...
        inventory_size.getSelectionModel().select(prodData.getSize());
        inventory_color.setText(prodData.getColor());
        
        image = new Image(path, 120, 127, false, true);
        inventory_imageView.setImage(image);
    }
    
    private String[] typeList = {"Tops", "Bottoms", "Dresses", "Footwear", "Accessories"};
    ...
    public void menuReceiptBtn() {
        ...
        if (totalP == 0 || menu_amount.getText().isEmpty()) {
            ...
            if (!paid) {
                ...
                alert.setTitle("Error Message");
                alert.setHeaderText(null);
                alert.setContentText("Please pay for the order first!");
                alert.showAndWait();
                return;
            }
            ...
            try {
                ...
                java.io.InputStream reportStream = getClass().getResourceAsStream("report.jrxml");
    ...
    public void logout() {
        ...
        try {
            ...
            if (option.get().equals(ButtonType.OK)) {
                ...
                stage.setTitle("Fashion Supply Chain");
